                ...
                <div class="w-full px-4 sm:w-1/2">
                  <div class="max-w-xs mx-auto">
                    ...
                    <a
                      ...
                      class="inline-block mr-8 text-blue-600 dark:text-blue-400 dark:hover:text-blue-300 hover:text-blue-700"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                    ...
                    <a
                      ...
                      class="inline-block mr-8 text-blue-400 dark:text-blue-400 dark:hover:text-blue-300 hover:text-blue-600"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                    ...
                    <a
                      ...
                      class="inline-block mr-8 text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
