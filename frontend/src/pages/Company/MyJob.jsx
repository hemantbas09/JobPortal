                  ...
                  <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                      <thead class="bg-gray-50 dark:bg-gray-800">
                        <tr className=''>
                          <th scope="col" class="  px-20 py-3.5 text-xl font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Title</th>
                          <th scope="col" class=" px-20 py-3.5 text-xl font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Created Date</th>
                          <th scope="col" class=" px-20 py-3.5 text-xl font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400"> Expired Date</th>
                          <th scope="col" class=" px-20 py-3.5 text-xl font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Applicants</th>
                                  ...
                                  <td class="px-4 py-4 text-xl font-medium text-gray-700 whitespace-nowrap">
                                    <div class="inline-flex items-center gap-x-3">
                                      ...
                                      <div class="flex items-center gap-x-2">
                                        ...
                                        <div>
                                          <h2 class="font-medium text-gray-800 dark:text-white ">{myJob.jobTitle}</h2>

                                        </div>
                                      </div>
                                    </div>
                                  </td>
                                  <td class="px-4 py-4 text-xl text-gray-500 dark:text-gray-300 whitespace-nowrap">{myJob.createDate}</td>
                                  <td class="px-4 py-4 text-xl text-gray-500 dark:text-gray-300 whitespace-nowrap">{myJob.deadlineDate}</td>
                                  <td class="px-4 py-4 text-xl text-gray-500 dark:text-gray-300 whitespace-nowrap">344 Applicants</td>
                                  <td class="px-12 py-4 text-xl font-medium text-gray-700 whitespace-nowrap">
                                    <div class={`inline-flex items-center px-3 py-1 rounded-full gap-x-2  dark:bg-gray-800 ${myJob.active === false ? "bg-green-100" : myJob.active === true ? "bg-red-300" : "bg-yellow-200"}`}>
                                      <span class={`h-1.5 w-1.5 rounded-full bg-emerald-500`}></span>

                                      {/* <h2 class={`text - sm font-normal  `}>{myJob.active}</h2> */}
