...
import { useUpdateJobMutation, useGetJobByJobIdQuery } from "../../Service/jobApi";
...
const EditJob = () => {
    ...
    const formattedDeadlineDate = job.deadlineDate ? new Date(job.deadlineDate).toISOString().split('T')[0] : '';
                ...
                <div className="  p-7 flex-1 mx-10  dark:bg-gray-800 h-screen left-30 ">
                    <div className="max-w-6xl mx-auto bg-white md:p-16 ">
                        <form onSubmit={handleSubmit}>
                            ...
                            {/* For More Enquiry */}
                            <div className="mb-6">
                                <label htmlFor="forEnquiry" className="block mb-2 text-xl font-medium text-gray-900 dark:text-gray-300">
                                    For Enquiry
                                </label>
                                <input
                                    onChange={handleInputs}
