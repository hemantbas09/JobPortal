      ...
      <footer className="bg-white dark:bg-gray-900">
        ...
        <div className="lg:flex justify-between">
          <div>
            ...
            <p className="max-w-sm mt-2 text-gray-500 dark:text-gray-400 text-xl pl-3">
              Join 31,000+ other and never miss out on new tips, tutorials, and
              more.
            </p>

            <div className="flex mt-6  gap-20 mb-8 pl-1">
              <a
                href="#"
          ...
          <div className="px-6 mt-10 ">
            <h3 className="text-gray-700 text-2xl font-bold uppercase dark:text-white">
              Contact
            </h3>
            <span className="block mt-2 text-xl text-gray-600 dark:text-gray-400 hover:underline">
              +977-9841119798
            </span>
            <span className="block mt-2 text-xl text-gray-600 dark:text-gray-400 hover:underline">
        ...
        <div>
          <p className="text-center text-gray-500 dark:text-gray-400 text-xl">
            © Hemant 2020 - All rights reserved
          </p>
        </div>
      </footer>
    </>
