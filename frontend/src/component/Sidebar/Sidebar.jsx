                ...
                <div class="overflow-y-auto overflow-hidden flex flex-col justify-between flex-grow">
                    <ul class="flex flex-col py-4 space-y-1">
                        <div class="  flex flex-col items-center mt-6 -mx-2 ">
                            <img class="opacity md:block object-cover w-10 h-10 md:w-24 md:h-24 mx-2 rounded-full" src="https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80" alt="avatar"/>
